...
trazabilidad:
  ddr:
    - DDR-XX
---
# CU-VIS-002 Editar la propuesta dentro de la ventana de modificación

## Objetivo

Permitir al Aplicante editar y reenviar su propuesta de visita escolar mientras esté en *Pendiente a revisión* o en *Solicitud de cambios*, dentro de la ventana de modificación habilitada.
