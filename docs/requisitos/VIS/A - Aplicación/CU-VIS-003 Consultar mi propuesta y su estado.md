...
trazabilidad:
  ddr:
    - DDR-XX
---
# CU-VIS-003 Consultar mi propuesta y su estado

## Objetivo

Permitir al Aplicante consultar el estado de su propuesta de visita escolar (*Pendiente a revisión*, *Aceptada*, *Solicitud de cambios* o *Rechazada*).
