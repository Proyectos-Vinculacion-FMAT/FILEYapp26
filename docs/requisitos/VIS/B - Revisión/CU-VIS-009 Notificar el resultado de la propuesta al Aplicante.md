...
trazabilidad:
  ddr:
    - DDR-XX
---
# CU-VIS-009 Notificar el resultado de la propuesta al Aplicante

## Objetivo

Comunicar al Aplicante el resultado de la revisión de su propuesta de visita escolar (*Aceptada*, *Solicitud de cambios* o *Rechazada*) y dejar constancia de su envío.
