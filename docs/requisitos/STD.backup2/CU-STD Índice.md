...
> su módulo: `A - Solicitud/`, `B - Reserva/`, `C - Pago/`, `D - Confirmación y estados/`
...
- CU-STD-026 Notificar al aplicante que su reserva puede cancelarse — *Sistema*
...
- CU-STD-033 Consultar la lista de expositores con solicitud aceptada (habilitados para reservar) — *Administrador*
