...
trazabilidad:
  ddr:
    - DDR-XX
---
# CU-SAL-007 Consultar el catálogo compartido de salas y salones
...
Permitir a cualquier Administrador consultar el catálogo común de salas y salones —y, desde la misma pantalla, dar de alta salones y salas y editar sus propiedades— para coordinar el uso de los espacios.

## Alcance

Aplica al catálogo compartido y visible para todos los Administradores, sin distinción de panel (eventos o talleres). No aplica a stands.
...
2. El sistema muestra todos los salones del catálogo compartido, cada uno con sus salas.
