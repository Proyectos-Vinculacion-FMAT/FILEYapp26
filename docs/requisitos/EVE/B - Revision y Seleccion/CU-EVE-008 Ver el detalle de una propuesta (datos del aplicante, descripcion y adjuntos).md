...
reglas_de_negocio: []
---
# CU-EVE-008 Ver el detalle de una propuesta (datos del aplicante, descripción y adjuntos)
...
Módulo EVE — vista de detalle de propuesta. Es la antesala del dictamen (CU-EVE-009). No cubre la edición de la propuesta por parte del proponente (CU-EVE-004).
...
El administrador selecciona una propuesta desde la lista (CU-EVE-007).
...
6. Desde el detalle, el administrador puede iniciar el dictamen (CU-EVE-009).
