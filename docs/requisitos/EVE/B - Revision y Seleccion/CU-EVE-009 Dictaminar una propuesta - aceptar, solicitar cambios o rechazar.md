...
reglas_de_negocio: []
---
# CU-EVE-009 Dictaminar una propuesta: aceptar, solicitar cambios o rechazar
...
Módulo EVE — dictamen de propuesta. Absorbe el rechazo con motivo (flujo alterno A2) y el cambio de dictamen ya emitido (flujo alterno A3). La notificación de aceptaciones y rechazos al proponente se realiza en lote (CU-EVE-013); la solicitud de cambios sí se notifica de inmediato. No cubre la asignación de sala y horario (módulo C).
...
Desde el detalle de una propuesta (CU-EVE-008), el administrador decide emitir su dictamen.
...
7. El sistema marca la propuesta como pendiente de notificación (`resultado_notificado = false`) para incluirla en el siguiente lote (CU-EVE-013).
...
5. El sistema notifica de inmediato al proponente por correo, para que pueda corregir y reenviar (CU-EVE-004) antes del cierre de la convocatoria.
