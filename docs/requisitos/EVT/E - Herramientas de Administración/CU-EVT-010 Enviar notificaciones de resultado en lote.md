...
reglas_de_negocio: []
---
# CU-EVT-010 Enviar notificaciones de resultado en lote
...
Módulo EVT — notificación de resultados de selección. Cubre las propuestas en estado `aceptada` o `rechazada` pendientes de comunicar. La solicitud de cambios se notifica de inmediato en CU-EVT-009 y no entra en este lote. No cubre la notificación de sala y horario, que es responsabilidad de `PRG` (ver CU-PRG-008 en `PRG/CU-PRG Índice.md`).
...
1. En el paso 5, el sistema detecta propuestas que ya tenían una notificación previa (`fecha_resultado_notificado` no nula) y cuyo dictamen cambió (CU-EVT-009, A3).
