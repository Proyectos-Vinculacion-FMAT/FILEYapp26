...
Módulo EVT — edición de propuesta existente. Solo aplica cuando la propuesta está en estado `cambios_solicitados` y la fecha actual no ha superado `fecha_cierre_convocatoria`. No cubre el primer envío de propuesta (CU-EVT-002) ni el dictamen del administrador (CU-EVT-009).
