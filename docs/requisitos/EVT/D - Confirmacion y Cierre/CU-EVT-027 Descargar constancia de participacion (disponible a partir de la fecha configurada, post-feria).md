...
reglas_de_negocio: []
---
# CU-EVT-027 Descargar constancia de participación (disponible a partir de la fecha configurada, post-feria)
...
Módulo EVE — entrega de constancias al proponente. Solo aplica a actividades que solicitaron constancia (`requiere_constancia = true`) y a partir de `fecha_constancias`. No cubre la configuración de esa fecha (CU-EVT-001).
