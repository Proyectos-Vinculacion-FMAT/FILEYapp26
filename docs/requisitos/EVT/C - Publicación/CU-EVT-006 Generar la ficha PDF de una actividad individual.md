...
reglas_de_negocio: []
---
# CU-EVT-006 Generar la ficha PDF de una actividad individual
...
Módulo EVT — generación de ficha individual. Produce un PDF de una sola actividad. No cubre la exportación del programa completo ni el detalle interactivo en la cartelera (ambos pendientes; ver "Pendientes" en `CU-EVT Índice.md`); para exportar el programa completo a Excel/Word ver CU-PRG-011 en `PRG/CU-PRG Índice.md`.
