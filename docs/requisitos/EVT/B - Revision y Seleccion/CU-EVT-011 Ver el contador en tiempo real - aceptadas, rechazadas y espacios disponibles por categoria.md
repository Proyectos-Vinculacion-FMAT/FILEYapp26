---
estado: pendiente para analizar
version: 0.1
tags:
  - requisitos
  - caso-de-uso
...
reglas_de_negocio: []
---
# CU-EVT-011 Ver el contador en tiempo real: aceptadas, rechazadas y espacios disponibles por categoría
...
Módulo EVE — panel de seguimiento de la selección. Es una vista de solo lectura que se actualiza con cada dictamen (CU-EVT-008). No modifica propuestas ni cupos.
