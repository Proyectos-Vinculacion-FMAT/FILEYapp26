...
Módulo EVE — notificación de resultados de selección. Cubre las propuestas en estado `aceptada` o `rechazada` pendientes de comunicar. La solicitud de cambios se notifica de inmediato en CU-EVT-008 y no entra en este lote. No cubre la notificación de sala y horario (CU-EVT-022).
...
1. En el paso 5, el sistema detecta propuestas que ya tenían una notificación previa (`fecha_resultado_notificado` no nula) y cuyo dictamen cambió (CU-EVT-008, A3).
