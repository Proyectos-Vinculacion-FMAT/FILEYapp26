...
reglas_de_negocio: []
---
# CU-EVT-007 Ver el detalle de una propuesta (datos del aplicante, descripción y adjuntos)
...
Módulo EVE — vista de detalle de propuesta. Es la antesala del dictamen (CU-EVT-008). No cubre la edición de la propuesta por parte del proponente (CU-EVT-004).
...
El administrador selecciona una propuesta desde la lista (CU-EVT-006).
...
6. Desde el detalle, el administrador puede iniciar el dictamen (CU-EVT-008).
