...
reglas_de_negocio: []
---
# CU-EVT-001 Configurar la convocatoria
...
Módulo EVT — sección de configuración de convocatoria. Solo aplica a usuarios con permisos administrativos del módulo EVT. No cubre la creación de la edición de la feria (`EdicionFeria`).
