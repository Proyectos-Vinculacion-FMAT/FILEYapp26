...
reglas_de_negocio: []
---
# CU-EVT-003 Enviar múltiples propuestas desde una misma cuenta sin recapturar datos de contacto
...
Módulo EVE — extensión del flujo de envío de propuesta (CU-EVT-002). Aplica mientras la convocatoria esté en estado `abierta`. No cubre el primer registro de propuesta, que corresponde a CU-EVT-002.
...
- Los mismos campos del formulario original (CU-EVT-002), con los datos de contacto y perfil precargados.
