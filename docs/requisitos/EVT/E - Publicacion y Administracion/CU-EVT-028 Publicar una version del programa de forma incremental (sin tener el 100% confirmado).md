...
reglas_de_negocio: []
---
# CU-EVT-028 Publicar una versión del programa de forma incremental (sin tener el 100% confirmado)
...
Módulo EVE — publicación del programa. Hace visibles en la cartelera pública (CU-EVT-031) las actividades incluidas en la versión publicada. No cierra el programa (eso es CU-EVT-026) ni asigna horarios (módulo C).
