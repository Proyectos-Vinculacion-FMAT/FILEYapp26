...
reglas_de_negocio: []
---
# CU-EVT-030 Generar la ficha PDF de una actividad individual (título, tipo, organiza, fecha, sala, horario)
...
Módulo EVE — generación de ficha individual. Produce un PDF de una sola actividad. No cubre la exportación del programa completo (CU-EVT-029) ni el detalle interactivo en la cartelera (CU-EVT-032).
