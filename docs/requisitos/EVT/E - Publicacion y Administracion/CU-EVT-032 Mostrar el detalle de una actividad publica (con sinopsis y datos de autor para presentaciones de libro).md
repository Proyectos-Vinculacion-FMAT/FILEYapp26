...
reglas_de_negocio: []
---
# CU-EVT-032 Mostrar el detalle de una actividad pública (con sinopsis y datos de autor para presentaciones de libro)
...
Módulo EVE — vista pública de detalle de actividad. Solo muestra actividades de la versión publicada (CU-EVT-028). Es de acceso público y de solo lectura.
...
El visitante selecciona una actividad desde la cartelera pública (CU-EVT-031).
