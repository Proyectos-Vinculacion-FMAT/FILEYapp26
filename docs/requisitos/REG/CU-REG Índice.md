...
- [x] **Pantalla de gestión de accesos administrativos.** Se mudó y se construyó: es `/f/<slug>/accesos/` ([CU-FER-003](<../FER/CU-FER-003 Dar de alta un administrador en mi feria.md>) y [CU-FER-004](<../FER/CU-FER-004 Retirar el acceso de un administrador de mi feria.md>), 2026-08-26), y quien la usa es el **dueño de cada feria**, no el equipo técnico. Lo que sigue abierto no es la pantalla, sino la **transferencia de propiedad**: un dueño que deja el proyecto todavía obliga a que el operador reasigne por consola.
