...
- **Entidades:** Editorial, SelloEditorial, Solicitud, Documento.
...
- **Reflejo de Sistema:** CU-STD-025 (aviso de posible cancelación), CU-STD-026 (confirmada),
  CU-STD-027 (pagada) se ven aquí como cambios de estado.
...
- **Entidades:** Solicitud, Editorial, Documento.

### A3 · Reservas (lista)
- **Objetivo:** consultar todas las reservas.
- **Contenido:** lista filtrable (por estado, expositor, saldo, vencimiento). Incluye la
  **cola/alerta de reservas vencidas** que alimenta CU-STD-024.
- **CU involucrados:** CU-STD-028.
...
- **Contenido:** datos de la reserva, contacto, stands, abonos y descuentos; concentra las
  ...
  - **Resolver una reserva vencida**: cancelar o prorrogar (nueva fecha) — CU-STD-035.
  - **Modificar la fecha de corte/bloqueo** — CU-STD-036.
- **CU involucrados:** CU-STD-029 (detalle, contenedor) + 018, 019, 020, 027, 028.
...
| CU-STD-024 | Notificar al admin las reservas vencidas (con o sin abono) | Alerta/cola en A3 → A4 |
| CU-STD-025 | Notificar al aplicante posible cancelación | Correo · banner en U5 |
| CU-STD-026 | Confirmar y bloquear al cubrir el 50% | U5 (estado) · correo |
| CU-STD-027 | Cambiar a Pagada al cubrir el 100% | U5 (estado) · correo |
...
| A1 · Solicitudes (lista) | CU-STD-004 |
| A2 · Detalle de solicitud | CU-STD-005, CU-STD-006, CU-STD-007 |
| A3 · Reservas (lista) | CU-STD-028 |
| A4 · Detalle de reserva | CU-STD-029, CU-STD-018, CU-STD-019, CU-STD-020, CU-STD-035, CU-STD-036 |
| A5 · Pagos por validar | CU-STD-018 |
| A6 · Expositores (lista) | CU-STD-030 |
| A7 · Detalle de expositor | CU-STD-031 |
| A8 · Mapa completo | CU-STD-032 |
| A9 · Editar espacio | CU-STD-033 |
| A10 · Configuración | CU-STD-034 |
