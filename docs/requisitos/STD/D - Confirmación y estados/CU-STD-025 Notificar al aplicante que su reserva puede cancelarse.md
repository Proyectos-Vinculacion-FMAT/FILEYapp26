...
dependencias:
  - CU-STD-022
---
# CU-STD-025 Notificar al aplicante que su reserva puede cancelarse
...
5. El sistema guarda un registro en la entidad `Notificacion` vinculada a la reserva y a la cuenta del aplicante.
6. El sistema activa un banner o aviso en la vista de "Mi reserva" (U5) advirtiendo sobre el vencimiento, el cual el aplicante verá al iniciar sesión (CU-STD-014).
...
- **Éxito:** El aplicante es debidamente avisado del riesgo de perder sus stands.
- **Fallo:** Si el correo falla, la advertencia persistirá dentro del portal.

## Reglas de negocio relacionadas

- **RN-12:** Notificar tanto al aplicante como al administrador sobre la expiración del plazo, antes de tomar medidas destructivas (cancelación).
