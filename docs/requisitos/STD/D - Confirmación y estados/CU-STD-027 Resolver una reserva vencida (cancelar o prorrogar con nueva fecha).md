...
dependencias:
  - CU-STD-032
---
# CU-STD-027 Resolver una reserva vencida (cancelar o prorrogar con nueva fecha)
...
6. El sistema guarda un registro en la `Bitacora` y dispara una notificación al usuario (entidad `Notificacion`).
