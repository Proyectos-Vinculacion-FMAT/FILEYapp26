...
dependencias:
  ...
  - CU-STD-019
---
# CU-STD-026 Confirmar y bloquear la reserva al cubrirse el 50% (+ notificar)

## Descripción

El sistema formaliza la posesión de los stands (cambiando el estado a Confirmada) en el momento en que detecta que los abonos validados por el administrador alcanzan la cuota mínima del 50%, y notifica al aplicante del éxito de la transacción.
