...
El administrador revisa un pago enviado por el aplicante, coteja el comprobante con los estados de cuenta bancarios y decide validarlo (sumándolo al saldo abonado de la reserva) o rechazarlo.
...
8. El sistema evalúa si el nuevo saldo total activa los procesos automáticos de confirmación (CU-STD-026, si se cubre el 50%) o de liquidación total (CU-STD-027, si se cubre el 100%).
...
6. El caso de uso termina (el aplicante podrá ver el estado de rechazo en su historial, CU-STD-017).
