...
8. El sistema evalúa si con el nuevo monto total reducido, el saldo que el usuario ya había abonado (`monto_abonado`) es suficiente para alcanzar el 50% o el 100%, disparando, si aplica, los procesos automáticos de confirmación (CU-STD-029) o liquidación (CU-STD-030).
