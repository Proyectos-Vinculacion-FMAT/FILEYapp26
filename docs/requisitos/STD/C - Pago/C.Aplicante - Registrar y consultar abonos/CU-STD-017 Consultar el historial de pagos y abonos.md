...
El aplicante visualiza la lista de todos los abonos o pagos que ha registrado para su reserva, incluyendo el estado de validación de cada uno (pendiente, validado o rechazado).
...
El aplicante navega a la sección de historial de pagos dentro del portal de su reserva.

## Flujo principal

1. El aplicante accede a la pestaña o sección de "Historial de pagos" (parte de la vista U6).
...
- **Éxito:** El aplicante visualiza de manera clara el estado de todos los comprobantes que ha enviado.
- **Fallo:** No aplica.
