...
dependencias:
  ...
  - CU-STD-028
---
# CU-STD-032 Ver el detalle de una reserva (abonos, contacto y acciones asociadas)
...
- El administrador ha seleccionado una reserva desde la lista (CU-STD-031) o desde el mapa (CU-STD-035).
...
6. A partir de esta vista, el administrador puede realizar distintas acciones sobre la reserva, como validar pagos (CU-STD-018), agregar abonos manuales (CU-STD-019), aplicar descuentos especiales (CU-STD-020), modificar fechas (CU-STD-028) o resolver vencimientos (CU-STD-027).
...
2. El sistema muestra un mensaje de error y redirige a la lista general de reservas (CU-STD-031).
