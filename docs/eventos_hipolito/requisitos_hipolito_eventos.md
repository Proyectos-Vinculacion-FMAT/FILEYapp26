...
**RFH-18 — Ventana acotada de solicitud de cambios**
Debe existir un periodo configurable durante el cual el proponente puede solicitar cambios a su horario asignado. Fuera de esa ventana, el sistema no debe permitir solicitudes de cambio por parte del proponente. **Fechas oficiales confirmadas** (`Convocatoria para Actividades FILEY 2027.pdf`): aviso de propuestas seleccionadas el 13 de noviembre (con fecha de participación, aún sin hora/salón); ventana de ajustes hasta el 7 de diciembre a las 16:00 horas; asignación de hora y sala/salón visible a partir del 22 de enero.
