...
reglas_de_negocio: []
---
# CU-EVT-029 Exportar el programa completo o un subconjunto a Excel, Word o PDF
...
Módulo EVE — exportación del programa. Genera un archivo descargable a partir de los datos del programa. No publica la cartelera pública (CU-EVT-028) ni genera la ficha individual de una actividad (CU-EVT-030).
