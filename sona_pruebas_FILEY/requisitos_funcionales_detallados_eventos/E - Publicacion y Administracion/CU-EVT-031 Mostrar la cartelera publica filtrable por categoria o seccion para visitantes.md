...
reglas_de_negocio: []
---
# CU-EVT-031 Mostrar la cartelera pública filtrable por categoría o sección para visitantes
...
Módulo EVE — cartelera pública. Muestra únicamente actividades de la versión publicada del programa (CU-EVT-028). Es de acceso público y de solo lectura. El detalle de cada actividad se cubre en CU-EVT-032.
...
5. El visitante selecciona una actividad para ver su detalle (CU-EVT-032).
